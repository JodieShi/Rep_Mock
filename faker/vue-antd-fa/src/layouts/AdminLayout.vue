  ...
  <a-layout :class="['admin-layout', 'beauty-scroll']">
    ...
    <a-layout class="admin-layout-main beauty-scroll">
      ...
      <a-layout-footer style="padding: 0px">
        <page-footer :link-list="foooterLinks" :copyright="copyright" />
      </a-layout-footer>
    </a-layout>
  </a-layout>
</template>
...
export default {
  name: 'AdminLayout',
  components: { Setting, AdminHeader, PageFooter, Drawer, SideMenu },
  data() {
    return {
...
.admin-layout {
  ...
  .setting {
    ...
    width: 40px;
    height: 40px;
    box-shadow: -24px 0 8px @shadow-color;
  }
}
</style>
