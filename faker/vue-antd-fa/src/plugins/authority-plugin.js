...
const getRoutePermission = (permission, route) => permission.find(item => item.id === route.meta.authority.permission)

const getRouteRole = (roles, route) => {
  const requiredRoles = route.meta.authority.roles
